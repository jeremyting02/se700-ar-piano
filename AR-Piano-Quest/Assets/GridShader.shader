Shader "Custom/GridShader"
{
    Properties
    {
        ...
        _GridScaleX ("Grid Scale X", Float) = 1.0
        _GridScaleZ ("Grid Scale Z", Float) = 1.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                o.uv = v.uv * float2(_GridScaleX, _GridScaleZ);
            #else
                ...
                float3 cameraCenteringOffset = floor(_WorldSpaceCameraPos * float3(_GridScaleX, _GridScaleX, _GridScaleZ));
                float3 cameraSnappedWorldPos = worldPos * float3(_GridScaleX, _GridScaleX, _GridScaleZ) - cameraCenteringOffset;
